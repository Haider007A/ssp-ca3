...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Top Cellphone Brands</title>
			...
			<body>
                ...
                Total: €
                <input type="text" name="txtBillAmt"/><input type="checkbox" name="cbOpts" value="isnew" id="shownew"/><label for="shownew">Highlight new Mobiles</label></p>
				</form>
			</body>
		</html>
	</xsl:template>
